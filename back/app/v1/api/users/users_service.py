...
from database.connect import get_user_db

load_dotenv()

SECRET = os.environ.get("JWT_SECRET")

class UserManager(UUIDIDMixin, BaseUserManager[UserTable, int]):
...
fastapi_users = FastAPIUsers[UserTable, int](get_user_manager, [auth_backend])
